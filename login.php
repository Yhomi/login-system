...
<div class="container"></div>
    <div class="row">
        <div class="col-md-12 offset-md-4">
            <h3 class="float-left mt-5 text-secondary">Login</h3>
            <form class="mt-5 pt-5" action="login.php" method="POST">
                ...
                <div class="form-group">
                    <button type="submit" name="submit" class="btn btn-primary btn-block btn-lg w-25"><i class="fa fa-user"></i>&nbsp;Login</button>
                </div>
                <p class="float-left" > Not yet a member? <a href="sign-up.php">Sign Up</a></p>
            </form>
        </div>
    </div>
</div>
